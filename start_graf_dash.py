...
def update_data_and_graph(start_time, end_time):
    ...
    try:
        ...
        fig_price_zt.add_trace(go.Scatter(x=time_price_zt, y=korol_komun_price, mode='lines', name='Корольова вулиця, 101 -> Комунальний провулок, 1 (58)'))
...
@app.callback(Output('price-graph-hark', 'figure'),Output('price-graph-zap','figure'),Output('price-graph-dnepr','figure'),Output('price-graph-kr','figure'),Output('price-graph-zt','figure'),
